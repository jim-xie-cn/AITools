...
import gc,torch,os,sys,warnings,random
sys.path.append("../")
import pandas as pd
...
class CLLMQA(object):
    ...
    def train(self,llm_dataset,max_length=g_default_max_length):
        ...
        tokenized_data,collate_fn=llm_dataset.get_qa_tokenized_data(tokenizer,max_length=max_length)
