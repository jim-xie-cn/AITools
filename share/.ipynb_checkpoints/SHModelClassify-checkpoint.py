...
class CSHAutoClassify():
    ...
    def __init__(self,ip='localhost',port=54321):
        ...
        self.m_models = {
            ...
            "ann":H2ODeepLearningEstimator(hidden=[200, 200],nfolds = 4)
        }
        
    def train(self,df_sample,x_columns = None ,y_column='label',train_ratio = 0.85):
    ...
    def predict(self,df_sample,x_columns = None,y_column='label'):
    ...
    def evaluate(self,df_sample,x_columns = None,y_column='label',average='weighted'):
...
def main():
    ...
    model_1 = CSHAutoClassify()
    model_1.train(df_train,y_column='y')
    model_1.save("./test")
    model_2 = CSHAutoClassify()
    model_2.load("./test")
